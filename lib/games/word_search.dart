      ...
      if (isNetwork) {
        _netManager.onMessageReceived = (packet) {
          if (packet['type'] == 'ws_setup') {
            ...
            final rawLocations = packet['data']['locations'] as Map<String, dynamic>;
            ...
            final highlightColor = isPeerHost ? AppTheme.neonCyan : AppTheme.neonPink;
                    ...
                    child: Container(
                      ...
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final isCurrentSelection = _selectedPath.contains(index);
                          // Check if cell is in a word already found
                          final isHighlighted = provider.highlightedCells.containsKey(index);
                          
                          Color cellColor = Colors.transparent;
                          if (isCurrentSelection) {
                            cellColor = AppTheme.neonOrange.withOpacity(0.3);
                          } else if (isHighlighted) {
                            cellColor = provider.highlightedCells[index]!.withOpacity(0.25);
                          }
                          ...
                          return Container(
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                fontSize: 16,
                                fontWeight: (isCurrentSelection || isHighlighted) ? FontWeight.bold : FontWeight.w500,
                                color: letterColor,
                              ),
                            ),
                          );
                        ...
                        children: provider.words.map((word) {
                          ...
                          return Text(
                            ...
                            style: TextStyle(
                              ...
                              color: isFound ? AppTheme.textSecondary.withOpacity(0.5) : Colors.white,
                            ),
                          );
                        }).toList(),
                      ),
