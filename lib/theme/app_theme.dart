...
class AppTheme {
  ...
  static const Color neonViolet = Color(
    0xFF7000FF,
  ); // Electric Purple (Primary)
  static const Color neonGreen = Color(
    0xFF00EEFC,
  ); // Success feedback uses Cyan
  static const Color neonOrange = Color(0xFFFF9500); // Vibrant orange
  static const Color neonPink = Color(
    0xFFFF006B,
  ); // saturated Magenta (Feedback Error)
  ...
  static BoxDecoration glassDecoration({required double borderRadius}) {
