...
class _GameShellState extends State<GameShell> {
  ...
  void _initiateOnlineReloadFlow() {
    ...
    final myRoleStr = _roomManager.role == OnlineRole.host ? 'host' : 'guest';
    _roomManager.sendGameState({'type': 'reload_request', 'sender': myRoleStr});
  }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      GlassButton(
                        ...
                        onPressed: () {
                          _dismissActiveDialog();
                          final myRoleStr = _roomManager.role == OnlineRole.host
                              ? 'host'
                              : 'guest';
                          _roomManager.sendGameState({
                            'type': 'reload_cancel',
        ...
        children: [
          ...
          WinOverlay(
            ...
            isOnlineOrNetworkGuest:
                (widget.isOnlineGame && roomManager.role == OnlineRole.guest) ||
