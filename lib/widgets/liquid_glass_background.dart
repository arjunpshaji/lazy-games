  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
        ...
        // Animated liquid blobs — LayoutBuilder is OUTSIDE AnimatedBuilder so
        // constraints are read once per layout pass, not 60 times per second.
        LayoutBuilder(
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          gradient: RadialGradient(
                            colors: [
                              const Color(0xFFC000FF).withValues(alpha: 0.55),
                              const Color(0xFFC000FF).withValues(alpha: 0.35),
                              const Color(0xFFC000FF).withValues(alpha: 0.0),
                            ],
                            stops: const [0.0, 0.5, 1.0],
                          ),
                        ),
